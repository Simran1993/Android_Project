...
public class SunriseMainActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowSavedLookups.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(SunriseMainActivity.this, SavedView.class);
    ...
    private void saveToDatabase() {
        ...
        if (!latitude.isEmpty() && !longitude.isEmpty() && !sunrise.isEmpty() && !sunset.isEmpty()) {
            ...
            Toast.makeText(SunriseMainActivity.this, "saved", Toast.LENGTH_SHORT).show();
        } else {

            Toast.makeText(SunriseMainActivity.this, "Please enter right value", Toast.LENGTH_SHORT).show();
        }
    }
    /**
    ...
    private void getSunriseSunsetInfo() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, apiUrl, response -> {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(SunriseMainActivity.this, "Parsing dawn and sunset data produces an error", Toast.LENGTH_SHORT).show();
            }
        }, error -> {
            Toast.makeText(SunriseMainActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
        });
